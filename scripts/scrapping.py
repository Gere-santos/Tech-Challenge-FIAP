...
def run_scraping():
    """Executa o scraping completo e retorna um resumo."""
    print("Iniciando scraping via API...")
    table, data = main()
    print(f"Scraping concluído. Total de livros: {len(table)}")
    return {"total_livros": len(table)}
